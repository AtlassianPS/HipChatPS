...
$manifestFile = "$moduleRoot\HipChatPS.psd1"
...
Describe "HipChatPS" {
    ...
    Context "Manifest, changelog, and AppVeyor" {
        ...
        It "Manifest file includes the correct root module" {
            $script:manifest.RootModule | Should Be 'HipChatPS.psm1'
        }

        It "Manifest file includes the correct guid" {
            $script:manifest.Guid | Should Be '346aca30-c3dc-433e-85b0-d894f5f318f3'
        }
